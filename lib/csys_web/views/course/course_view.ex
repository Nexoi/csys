defmodule CSysWeb.CourseView do
  ...
  def render("courses_page_with_conflict.json", %{courses_page: page}) do
    %{
      data: %{
        ...
        data: render_many(page.entries, CSysWeb.CourseView, "course_with_conflict.json")
      }
    }
  end
  ...
  def render("course_with_conflict.json", %{course: c}) do
    %{
      ...
      venue: c.venue,
      conflict_courses: c.conflict_courses
    }
  end
